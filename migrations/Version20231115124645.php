 ...
 */
final class Version20231115124645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire_event ADD evennement_id INT NOT NULL, CHANGE contenu contenu LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire_event DROP evennement_id, CHANGE contenu contenu VARCHAR(255) NOT NULL');
    }
}
