 ...
 */
final class Version20231116090640 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire_event ADD CONSTRAINT FK_BE22C2BBDCDFA082 FOREIGN KEY (evennement_id) REFERENCES evennement (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
